...
Follow general rules - [Vladimir__Bootstrapping a virtual machine](bootstrapping-a-virtual-machine-at-university-of-canterbury.md)
...
To mount directories [provided by ](setup-grid-at-university-of-canterbury.md)[grid](setup-grid-at-university-of-canterbury.md), the following has to be turned on:
