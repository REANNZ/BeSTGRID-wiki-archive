...
Other pages already document detailed instructions on how to [setup a GUMS server](setup-nggums-at-university-of-canterbury.md), and how to [configure local account mappings](setup-authtool-for-hpc-at-university-of-canterbury.md).
