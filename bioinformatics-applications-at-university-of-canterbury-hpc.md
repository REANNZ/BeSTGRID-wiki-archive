...
1. Fix problem with SumP hanging in MPI on error: [mrbayes-3.1.2-fix-sump-mpi.diff](attachments/Mrbayes-3.1.2-fix-sump-mpi.diff.txt) (
!Mrbayes-3.1.2-fix-sump-mpi.diff.txt!
)
2. Fix minor issue in mcmcdiagn param print: [mrbayes-3.1.2-fix-mcmcdiagnparamprint.diff](attachments/Mrbayes-3.1.2-fix-mcmcdiagnparamprint.diff.txt) (
!Mrbayes-3.1.2-fix-mcmcdiagnparamprint.diff.txt!
)
3. If compiling for 64-bit architecture, apply [mb_64bit_safe.patch](attachments/Mb_64bit-safe.patch.txt) (
